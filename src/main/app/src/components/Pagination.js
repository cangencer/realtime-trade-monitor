...
class Pagination extends Component {
  ...
  componentDidUpdate (prevProps, prevState) {
    console.log(prevProps.page, this.props.page, prevState.page, this.state.page);
  ...
  render() {
    const {extraData, page, canPrevious, canNext, defaultPage, defaultPageSize, onPageChange, onPageSizeChange, pageSize, pageSizeOptions, pages, rowsSelectorText, rowsText, pageJumpText} = this.props;
    ...
    return (<div className="Pagination">
      ...
      <div className="Pagination-right">
        ...
        >
          {pageSizeOptions.map((option, i) => <option key={i} value={option}>{`${option} ${rowsText}`}</option>)}
        </select>
      </div>
    </div>)
  }
